...
const projects = [
    ...
    cases: [
      {
        ...
        result: 'От проектирования до релиза',
      },
      {
        case: 'Интеграции',
  ...
  },
  {
    ...
    cases: [
      {
        case: 'Реализация бэкенд-логики',
        result: 'Реализовал аутентификацию, платежи, стримы и статистику',
      },
      {
      ...
      },
      {
        ...
        result: 'Сделал платформу более гибкой и отказоустойчивой',
      },
      {
        case: 'Релиз',
  ...
  },
  {
    ...
    cases: [
      ...
      {
        case: 'Создание модуля прогнозирования загрузки',
        result: 'Повысил качество и скорость управленческих решений',
      },
    ],
